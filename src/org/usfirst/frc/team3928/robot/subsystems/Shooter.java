...
public class Shooter
{
	...
	public Shooter()
	{
		 t0 = new Talon(Constants.SHOOTER_0);
	     t1 = new Talon(Constants.SHOOTER_1);
		 break0 = new DigitalInput(Constants.BEAMBREAKER_0_CHANNEL);
	     break1 = new DigitalInput(Constants.BEAMBREAKER_1_CHANNEL);
	}

...
public class BDHighGoalLeftTime implements AutoMode
{
	private AutoDriver driver;
	private Shooter shooter;
	private Intake intake;

	public BDHighGoalLeftTime(AutoDriver driver, Shooter shooter, Intake intake, Drive drive)
	{
		this.driver = driver;
	...
	{
		return "B and D Defenses High Goal Rotate Left (time)";
	}
